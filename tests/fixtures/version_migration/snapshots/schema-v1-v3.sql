...
CREATE TABLE series_source (
    ...
    space_url TEXT NOT NULL DEFAULT '', uid INTEGER, type TEXT NOT NULL DEFAULT 'space', sid INTEGER
);
CREATE TABLE sync_policy (
    series TEXT PRIMARY KEY REFERENCES series(series) ON DELETE CASCADE,
    page_size INTEGER NOT NULL DEFAULT 20,
    incremental_page_size INTEGER NOT NULL DEFAULT 5,
    max_pages INTEGER NOT NULL DEFAULT 10,
    max_requests_per_series INTEGER NOT NULL DEFAULT 8,
    ...
    keep_last INTEGER NOT NULL DEFAULT 100,
...
CREATE TABLE scheduler_backend (
    series TEXT PRIMARY KEY REFERENCES series(series) ON DELETE CASCADE,
...
INSERT INTO series(series, title, author) VALUES('series-one', 'Fixture Series', 'Fixture Author');
INSERT INTO sync_state(series, last_success_at) VALUES('series-one', 1700000000);
