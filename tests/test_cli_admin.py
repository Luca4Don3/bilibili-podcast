...
def test_crontab_excludes_disabled_schedule(tmp_path: Path) -> None:
    ...
    # bilibili-podcast-crontab checks for placeholder values in env; provide dummy ones
    ...
    result = subprocess.run(
        ...
        env={
            "BILIBILI_PODCAST_MEDIA_BASE_URL": "http://test:8080",
            "BILIBILI_PODCAST_RSYNC_HOST": "test-rsync",
            "BILIBILI_PODCAST_RSYNC_PORT": "22",
            "BILIBILI_PODCAST_RSYNC_USER": "test",
            "BILIBILI_PODCAST_RSYNC_SECRET": str(secret_file),
        },
    )
