...
def _load_web_server(monkeypatch, db_path: Path):
    monkeypatch.setenv("BILIBILI_PODCAST_CONFIG_DB", str(db_path))
    monkeypatch.setenv("BILIBILI_PODCAST_WEB_PASSWORD", "test-password")
...
def test_manual_media_attach_rebuilds_and_publishes_rss(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setenv("BILIBILI_PODCAST_MEDIA_ROOT", str(media_root))
    monkeypatch.setenv("BILIBILI_PODCAST_JSON_ROOT", str(json_root))
    monkeypatch.setenv("BILIBILI_PODCAST_RSS_ROOT", str(rss_root))
    monkeypatch.setenv("BILIBILI_PODCAST_MEDIA_BASE_URL", "http://media.test")
    monkeypatch.setenv("BILIBILI_PODCAST_MANUAL_MEDIA_DIRS", str(allow_dir))
