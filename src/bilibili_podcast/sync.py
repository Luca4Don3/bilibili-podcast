...
DEFAULT_LOG_DIR = "/var/log/bilibili-podcast"
LOG_LEVELS = {
    "DEBUG": logging.DEBUG,
    "INFO": logging.INFO,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--media-root", default="/var/lib/bilibili-podcast/media")
    parser.add_argument("--json-root", default="/var/lib/bilibili-podcast/json")
    parser.add_argument("--rss-root", default="/var/lib/bilibili-podcast/rss")
