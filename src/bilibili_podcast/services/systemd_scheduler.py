...
SYSTEMD_DIR = Path(os.environ.get("BILIBILI_PODCAST_SYSTEMD_DIR", "/etc/systemd/system"))
APP_DIR = Path(os.environ.get("BILIBILI_PODCAST_APP_DIR", "<server_path>"))
ENV_FILE = Path(os.environ.get("BILIBILI_PODCAST_ENV_FILE", "<server_path>"))
VENV_BIN = Path(os.environ.get("BILIBILI_PODCAST_VENV_BIN", "<server_path>"))
STATE_DIR = Path(os.environ.get("BILIBILI_PODCAST_STATE_DIR", "/var/lib/bilibili-podcast/state"))
SECRETS_DIR = Path(os.environ.get("BILIBILI_PODCAST_SECRETS_DIR", "<server_path>"))
...
LOG_DIR = Path(os.environ.get("BILIBILI_PODCAST_LOG_DIR", "/var/log/bilibili-podcast"))
BROWSER_DATA_ROOT = Path(os.environ.get("BILIBILI_PODCAST_BROWSER_USER_DATA_ROOT",
                                         "<server_path>"))
...
MEDIA_BASE_URL = (
    os.environ.get("BILIBILI_PODCAST_MEDIA_BASE_URL")
...
_RSS_PUBLISH = Path(os.environ.get("BILIBILI_PODCAST_RSS_PUBLISH",
                                     "<server_path>"))
