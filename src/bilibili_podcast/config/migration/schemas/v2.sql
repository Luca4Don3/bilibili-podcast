-- Immutable SQLite schema snapshot for unified installation v2.
...
CREATE TABLE sync_policy (
  ...
  format TEXT NOT NULL DEFAULT 'audio', quality TEXT NOT NULL DEFAULT '64K',
  fetch_strategy TEXT NOT NULL DEFAULT 'api_first', keep_last INTEGER NOT NULL DEFAULT 100,
