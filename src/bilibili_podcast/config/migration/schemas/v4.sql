-- Immutable SQLite schema snapshot for unified installation v4.
CREATE TABLE schema_version (version INTEGER PRIMARY KEY);
CREATE TABLE series (
  series TEXT PRIMARY KEY CHECK(series GLOB '[a-z0-9][a-z0-9_-]*'),
  enabled INTEGER NOT NULL DEFAULT 1, title TEXT NOT NULL,
  description TEXT NOT NULL DEFAULT '', author TEXT NOT NULL,
  cover_art TEXT NOT NULL DEFAULT '', category TEXT NOT NULL DEFAULT '',
  subcategories TEXT NOT NULL DEFAULT '[]', explicit INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE series_source (
  ...
  type TEXT NOT NULL DEFAULT 'space' CHECK(type IN ('space','season','series')), sid INTEGER
);
